...
/datum/species/reptile/get_scream_sound(mob/living/carbon/human/our_mob)
...
/datum/species/reptile/get_cough_sound(mob/living/carbon/human/our_mob)
...
/datum/species/reptile/get_cry_sound(mob/living/carbon/human/our_mob)
	if(our_mob.physique == FEMALE)
		return pick(
...
/datum/species/reptile/get_sneeze_sound(mob/living/carbon/human/our_mob)
	if(our_mob.physique == FEMALE)
		return 'sound/mobs/humanoids/human/sneeze/female_sneeze1.ogg'
	return 'sound/mobs/humanoids/human/sneeze/male_sneeze1.ogg'

/datum/species/reptile/get_laugh_sound(mob/living/carbon/human/our_mob)
	if(our_mob.physique == FEMALE)
...
/datum/species/reptile/get_sigh_sound(mob/living/carbon/human/our_mob)
	if(our_mob.physique == FEMALE)
		return SFX_FEMALE_SIGH
	return SFX_MALE_SIGH

/datum/species/reptile/get_sniff_sound(mob/living/carbon/human/our_mob)
	if(our_mob.physique == FEMALE)
		return 'sound/mobs/humanoids/human/sniff/female_sniff.ogg'
	return 'sound/mobs/humanoids/human/sniff/male_sniff.ogg'

/datum/species/reptile/get_snore_sound(mob/living/carbon/human/our_mob)
	if(our_mob.physique == FEMALE)
		return SFX_SNORE_FEMALE
	return SFX_SNORE_MALE

/datum/species/reptile/get_hiss_sound(mob/living/carbon/human/our_mob)
